      ...
      >
        ...
        <div v-if="isOpen(level)" class="roadmap__stages">
          <GrammarStageCard
            ...
            :stage="{ ...stage, cefr: level.cefr }"
            :can-open="canOpenStage({ ...stage, cefr: level.cefr })"
...
const props = defineProps({
  ...
  canOpenStage: { type: Function, default: null },
})
...
function canOpenStage(stage) {
  if (typeof props.canOpenStage === 'function') return props.canOpenStage(stage)
