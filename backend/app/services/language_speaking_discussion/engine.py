...
async def submit_discussion_response(
    ...
    *,
    ...
    if state.assistant_turns_used >= step.max_assistant_turns:
    ...
    if auto_advance and len(text.split()) >= 3:
    ...
    return _view(
        ...
        latest_assistant={
            ...
            or state.assistant_turns_used >= step.max_assistant_turns,
        },
    )
