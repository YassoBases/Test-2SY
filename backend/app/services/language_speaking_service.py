...
def _prompt_out(item, progress: LanguageSpeakingProgress | None, public_url: str | None = None) -> dict:
...
async def list_speaking(db: AsyncSession, *, student_id: int) -> dict:
    ...
    for item in items:
        ...
        out.append(_prompt_out(item, p, url))
    return {
